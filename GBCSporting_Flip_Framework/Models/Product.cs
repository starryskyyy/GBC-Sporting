...
namespace GBCSporting_Flip_Framework.Models
{
    public class Product
    {
        ...
        [RegularExpression("^[a-zA-Z0-9-]+$", ErrorMessage = "Product Code may not contain any special characters.")]
        public string? Code { get; set; }

        [Required(ErrorMessage = "Please enter a name of the product")]
        [RegularExpression("^[a-zA-Z0-9 -.]+$", ErrorMessage = "Product Name may not contain any special characters.")]
